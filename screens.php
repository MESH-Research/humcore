...
<form id="deposit-form" name="deposit-form" class="standard-form" method="post" enctype="multipart/form-data">
	...
	<?php wp_nonce_field( 'new_core_deposit', 'new_core_deposit_nonce' ); ?>
		...
		<input type="hidden" name="selected_temp_name" id="selected_temp_name" value="
		<?php
		if ( ! empty( $prev_val['selected_temp_name'] ) ) {
			echo sanitize_text_field( $prev_val['selected_temp_name'] ); }
?>
" />
		<input type="hidden" name="selected_file_name" id="selected_file_name" value="
		<?php
		if ( ! empty( $prev_val['selected_file_name'] ) ) {
			echo sanitize_text_field( $prev_val['selected_file_name'] ); }
?>
" />
		<input type="hidden" name="selected_file_type" id="selected_file_type" value="
		<?php
		if ( ! empty( $prev_val['selected_file_type'] ) ) {
			echo sanitize_text_field( $prev_val['selected_file_type'] ); }
?>
" />
		<input type="hidden" name="selected_file_size" id="selected_file_size" value="
		<?php
		if ( ! empty( $prev_val['selected_file_type'] ) ) {
			echo sanitize_text_field( $prev_val['selected_file_size'] ); }
?>
" />
		<input type="hidden" name="deposit-form-type" id="deposit-form-type" value="<?php echo $form_type; ?>" />
		<input type="hidden" name="deposit_blog_id" id="deposit_blog_id" value="
		<?php
		if ( ! empty( $prev_val['deposit_blog_id'] ) ) {
			echo sanitize_text_field( $prev_val['deposit_blog_id'] ); }
?>
" />
		<input type="hidden" name="deposit_post_id" id="deposit_post_id" value="
		<?php
		if ( ! empty( $prev_val['deposit_post_id'] ) ) {
			echo sanitize_text_field( $prev_val['deposit_post_id'] ); }
?>
" />
...
<br />
		...
		<input type="text" id="deposit-title-unchanged" name="deposit-title-unchanged" size="75" class="long" value="
		<?php
...
?>
	...
	<div id="deposit-conference-title-entry">
		...
		<input type="text" name="deposit-conference-title" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-conference-title'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-conference-title'] ); }
?>
" />
	</div>
	...
	<div id="deposit-conference-organization-entry">
		...
		<input type="text" name="deposit-conference-organization" size="60" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-conference-organization'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-conference-organization'] ); }
?>
" />
	</div>
	...
	<div id="deposit-conference-location-entry">
		...
		<input type="text" name="deposit-conference-location" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-conference-location'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-conference-location'] ); }
?>
" />
	</div>
	...
	<div id="deposit-conference-date-entry">
		...
		<input type="text" name="deposit-conference-date" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-conference-date'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-conference-date'] ); }
?>
" />
	</div>
	</div>
	...
	<div id="deposit-meeting-title-entry">
		...
		<input type="text" name="deposit-meeting-title" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-meeting-title'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-meeting-title'] ); }
?>
" />
	</div>
	...
	<div id="deposit-meeting-organization-entry">
		...
		<input type="text" name="deposit-meeting-organization" size="60" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-meeting-organization'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-meeting-organization'] ); }
?>
" />
	</div>
	...
	<div id="deposit-meeting-location-entry">
		...
		<input type="text" name="deposit-meeting-location" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-meeting-location'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-meeting-location'] ); }
?>
" />
	</div>
	...
	<div id="deposit-meeting-date-entry">
		...
		<input type="text" name="deposit-meeting-date" size="75" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-meeting-date'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-meeting-date'] ); }
?>
" />
	</div>
	</div>
	...
	<div id="deposit-institution-entry">
		...
		<input type="text" name="deposit-institution" size="60" class="text" value="
		<?php
		if ( ! empty( $prev_val['deposit-institution'] ) ) {
			echo sanitize_text_field( $prev_val['deposit-institution'] ); }
?>
" />
	</div>
	</div>
...
?>
>Translator &nbsp;</span>
		<input type="hidden" name="deposit-author-uni" id="deposit-author-uni" value="
		<?php
		if ( 'new' === $form_type ) {
			echo $user_login;
...
<?php format_proceedings_article_input( $prev_val ); ?>
	<div id="deposit-non-published-entries">
		...
		<div id="deposit-non-published-date-entry">
			...
			<input type="text" id="deposit-non-published-date" name="deposit-non-published-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-non-published-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-non-published-date'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-book-entries">
		...
		<div id="deposit-book-doi-entry">
			...
			<input type="text" id="deposit-book-doi" name="deposit-book-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-publisher-entry">
			...
			<input type="text" id="deposit-book-publisher" name="deposit-book-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-publish-date-entry">
			...
			<input type="text" id="deposit-book-publish-date" name="deposit-book-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-edition-entry">
			...
			<input type="text" id="deposit-book-edition" name="deposit-book-edition" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-edition'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-edition'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-volume-entry">
			...
			<input type="text" id="deposit-book-volume" name="deposit-book-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-volume'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-isbn-entry">
			...
			<input type="text" id="deposit-book-isbn" name="deposit-book-isbn" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-isbn'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-isbn'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-book-chapter-entries">
		...
		<div id="deposit-book-chapter-doi-entry">
			...
			<input type="text" id="deposit-book-chapter-doi" name="deposit-book-chapter-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-publisher-entry">
			...
			<input type="text" id="deposit-book-chapter-publisher" name="deposit-book-chapter-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-publish-date-entry">
			...
			<input type="text" id="deposit-book-chapter-publish-date" name="deposit-book-chapter-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-title-entry">
			...
			<input type="text" id="deposit-book-chapter-title" name="deposit-book-chapter-title" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-author-entry">
			...
			<input type="text" id="deposit-book-chapter-author" name="deposit-book-chapter-author" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-author'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-author'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-chapter-entry">
			...
			<input type="text" id="deposit-book-chapter-chapter" name="deposit-book-chapter-chapter" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-chapter'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-chapter'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-pages-entry">
			...
			<input type="text" id="deposit-book-chapter-start-page" name="deposit-book-chapter-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-start-page'] ); }
?>
" />
			<label for="deposit-book-chapter-end-page">End Page</label>
			<input type="text" id="deposit-book-chapter-end-page" name="deposit-book-chapter-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-end-page'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-chapter-isbn-entry">
			...
			<input type="text" id="deposit-book-chapter-isbn" name="deposit-book-chapter-isbn" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-chapter-isbn'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-chapter-isbn'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-book-review-entries">
		...
		<div id="deposit-book-review-doi-entry">
			...
			<input type="text" id="deposit-book-review-doi" name="deposit-book-review-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-review-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-review-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-review-publisher-entry">
			...
			<input type="text" id="deposit-book-review-publisher" name="deposit-book-review-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-review-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-review-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-review-publish-date-entry">
			...
			<input type="text" id="deposit-book-review-publish-date" name="deposit-book-review-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-review-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-review-publish-date'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-book-section-entries">
		...
		<div id="deposit-book-section-doi-entry">
			...
			<input type="text" id="deposit-book-section-doi" name="deposit-book-section-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-publisher-entry">
			...
			<input type="text" id="deposit-book-section-publisher" name="deposit-book-section-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-publish-date-entry">
			...
			<input type="text" id="deposit-book-section-publish-date" name="deposit-book-section-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-title-entry">
			...
			<input type="text" id="deposit-book-section-title" name="deposit-book-section-title" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-author-entry">
			...
			<input type="text" id="deposit-book-section-author" name="deposit-book-section-author" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-author'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-author'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-edition-entry">
			...
			<input type="text" id="deposit-book-section-edition" name="deposit-book-section-edition" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-edition'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-edition'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-pages-entry">
			...
			<input type="text" id="deposit-book-section-start-page" name="deposit-book-section-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-start-page'] ); }
?>
" />
			<label for="deposit-book-section-end-page">End Page</label>
			<input type="text" id="deposit-book-section-end-page" name="deposit-book-section-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-end-page'] ); }
?>
" />
		</div>
		...
		<div id="deposit-book-section-isbn-entry">
			...
			<input type="text" id="deposit-book-section-isbn" name="deposit-book-section-isbn" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-book-section-isbn'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-book-section-isbn'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-journal-entries">
		...
		<div id="deposit-journal-doi-entry">
			...
			<input type="text" id="deposit-journal-doi" name="deposit-journal-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-journal-publisher-entry">
			...
			<input type="text" id="deposit-journal-publisher" name="deposit-journal-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-journal-publish-date-entry">
			...
			<input type="text" id="deposit-journal-publish-date" name="deposit-journal-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-journal-title-entry">
			...
			<input type="text" id="deposit-journal-title" name="deposit-journal-title" size="75" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-journal-volume-entry">
			...
			<input type="text" id="deposit-journal-volume" name="deposit-journal-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-volume'] ); }
?>
" />
			</label>
			<label for="deposit-journal-issue"><span>Issue</span>
			<input type="text" id="deposit-journal-issue" name="deposit-journal-issue" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-issue'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-issue'] ); }
?>
" />
			</label>
			<br style='clear:both'>
		...
		<div id="deposit-journal-pages-entry">
			...
			<input type="text" id="deposit-journal-start-page" name="deposit-journal-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-start-page'] ); }
?>
" />
			<label for="deposit-journal-end-page">End Page</label>
			<input type="text" id="deposit-journal-end-page" name="deposit-journal-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-end-page'] ); }
?>
" />
		</div>
		...
		<div id="deposit-journal-issn-entry">
			...
			<input type="text" id="deposit-journal-issn" name="deposit-journal-issn" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-journal-issn'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-journal-issn'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-magazine-section-entries">
		...
		<div id="deposit-magazine-section-url-entry">
			...
			<input type="text" id="deposit-magazine-section-url" name="deposit-magazine-section-url" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-url'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-url'] ); }
?>
" />
		</div>
		...
		<div id="deposit-magazine-section-publish-date-entry">
			...
			<input type="text" id="deposit-magazine-section-publish-date" name="deposit-magazine-section-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-magazine-section-title-entry">
			...
			<input type="text" id="deposit-magazine-section-title" name="deposit-magazine-section-title" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-magazine-section-volume-entry">
			...
			<input type="text" id="deposit-magazine-section-volume" name="deposit-magazine-section-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-volume'] ); }
?>
" />
		</div>
		...
		<div id="deposit-magazine-section-pages-entry">
			...
			<input type="text" id="deposit-magazine-section-start-page" name="deposit-magazine-section-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-start-page'] ); }
?>
" />
			<label for="deposit-magazine-section-end-page">End Page</label>
			<input type="text" id="deposit-magazine-section-end-page" name="deposit-magazine-section-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-magazine-section-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-magazine-section-end-page'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-monograph-entries">
		...
		<div id="deposit-monograph-doi-entry">
			...
			<input type="text" id="deposit-monograph-doi" name="deposit-monograph-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-monograph-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-monograph-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-monograph-publisher-entry">
			...
			<input type="text" id="deposit-monograph-publisher" name="deposit-monograph-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-monograph-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-monograph-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-monograph-publish-date-entry">
			...
			<input type="text" id="deposit-monograph-publish-date" name="deposit-monograph-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-monograph-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-monograph-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-monograph-isbn-entry">
			...
			<input type="text" id="deposit-monograph-isbn" name="deposit-monograph-isbn" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-monograph-isbn'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-monograph-isbn'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-newspaper-article-entries">
		...
		<div id="deposit-newspaper-article-url-entry">
			...
			<input type="text" id="deposit-newspaper-article-url" name="deposit-newspaper-article-url" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-url'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-url'] ); }
?>
" />
		</div>
		...
		<div id="deposit-newspaper-article-publish-date-entry">
			...
			<input type="text" id="deposit-newspaper-article-publish-date" name="deposit-newspaper-article-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-newspaper-article-title-entry">
			...
			<input type="text" id="deposit-newspaper-article-title" name="deposit-newspaper-article-title" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-newspaper-article-edition-entry">
			...
			<input type="text" id="deposit-newspaper-article-edition" name="deposit-newspaper-article-edition" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-edition'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-edition'] ); }
?>
" />
		</div>
		...
		<div id="deposit-newspaper-article-volume-entry">
			...
			<input type="text" id="deposit-newspaper-article-volume" name="deposit-newspaper-article-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-volume'] ); }
?>
" />
		</div>
		...
		<div id="deposit-newspaper-article-pages-entry">
			...
			<input type="text" id="deposit-newspaper-article-start-page" name="deposit-newspaper-article-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-start-page'] ); }
?>
" />
			<label for="deposit-newspaper-article-end-page">End Page</label>
			<input type="text" id="deposit-newspaper-article-end-page" name="deposit-newspaper-article-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-newspaper-article-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-newspaper-article-end-page'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-online-publication-entries">
		...
		<div id="deposit-online-publication-url-entry">
			...
			<input type="text" id="deposit-online-publication-url" name="deposit-online-publication-url" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-url'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-url'] ); }
?>
" />
		</div>
		...
		<div id="deposit-online-publication-publisher-entry">
			...
			<input type="text" id="deposit-online-publication-publisher" name="deposit-online-publication-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-online-publication-publish-date-entry">
			...
			<input type="text" id="deposit-online-publication-publish-date" name="deposit-online-publication-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-online-publication-title-entry">
			...
			<input type="text" id="deposit-online-publication-title" name="deposit-online-publication-title" size="60" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-online-publication-edition-entry">
			...
			<input type="text" id="deposit-online-publication-edition" name="deposit-online-publication-edition" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-edition'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-edition'] ); }
?>
" />
		</div>
		...
		<div id="deposit-online-publication-volume-entry">
			...
			<input type="text" id="deposit-online-publication-volume" name="deposit-online-publication-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-online-publication-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-online-publication-volume'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-podcast-entries">
		...
		<div id="deposit-podcast-url-entry">
			...
			<input type="text" id="deposit-podcast-url" name="deposit-podcast-url" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-podcast-url'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-podcast-url'] ); }
?>
" />
		</div>
		...
		<div id="deposit-podcast-publisher-entry">
			...
			<input type="text" id="deposit-podcast-publisher" name="deposit-podcast-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-podcast-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-podcast-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-podcast-publish-date-entry">
			...
			<input type="text" id="deposit-podcast-publish-date" name="deposit-podcast-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-podcast-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-podcast-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-podcast-volume-entry">
			...
			<input type="text" id="deposit-podcast-volume" name="deposit-podcast-volume" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-podcast-volume'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-podcast-volume'] ); }
?>
" />
		</div>
...
?>
	...
	<div id="deposit-proceedings-entries">
		...
		<div id="deposit-proceeding-doi-entry">
			...
			<input type="text" id="deposit-proceeding-doi" name="deposit-proceeding-doi" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-doi'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-doi'] ); }
?>
" />
		</div>
		...
		<div id="deposit-proceeding-publisher-entry">
			...
			<input type="text" id="deposit-proceeding-publisher" name="deposit-proceeding-publisher" size="40" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-publisher'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-publisher'] ); }
?>
" />
		</div>
		...
		<div id="deposit-proceeding-publish-date-entry">
			...
			<input type="text" id="deposit-proceeding-publish-date" name="deposit-proceeding-publish-date" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-publish-date'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-publish-date'] ); }
?>
" />
		</div>
		...
		<div id="deposit-proceeding-title-entry">
			...
			<input type="text" id="deposit-proceeding-title" name="deposit-proceeding-title" size="75" class="long" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-title'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-title'] ); }
?>
" />
		</div>
		...
		<div id="deposit-proceeding-pages-entry">
			...
			<input type="text" id="deposit-proceeding-start-page" name="deposit-proceeding-start-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-start-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-start-page'] ); }
?>
" />
			<label for="deposit-proceeding-end-page">End Page</label>
			<input type="text" id="deposit-proceeding-end-page" name="deposit-proceeding-end-page" size="5" class="text" value="
			<?php
			if ( ! empty( $prev_val['deposit-proceeding-end-page'] ) ) {
				echo sanitize_text_field( $prev_val['deposit-proceeding-end-page'] ); }
?>
" />
		</div>
